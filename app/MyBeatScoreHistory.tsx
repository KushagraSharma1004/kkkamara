...
const MyBeatScoreHistory = ({ mobileNumber }) => {
...
const fullMobileNumber = '+' + mobileNumber.replace(/\s+/g, '');
    ...
    const fetchScoreHistory = async () => {
      if (fullMobileNumber) {
        ...
        if (docSnap.exists()) {
          ...
          const history = docSnap.data().MyBeatScoreHistory || [];
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>My Beat Score History</Text>
      <FlatList
        data={[...scoreHistory].reverse()} // Reverse the array to show latest items at the top
...
export default MyBeatScoreHistory;
